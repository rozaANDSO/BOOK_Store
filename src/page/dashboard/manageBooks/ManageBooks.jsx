...
import { useAddBookMutation, useFetchBookByIdQuery } from '../../../redux/features/books/BookApii';

const ManageBooks = () => {
    const navigate = useNavigate();

    const {data: books, refetch} = useFetchBookByIdQuery()

    const [deleteBook] = useAddBookMutation()
